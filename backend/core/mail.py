...
async def send_otp_email(target_email: str, code: str):
    ...
    <head>
        ...
        <style>
            ...
            .content a.btn {{ color: #ffffff; background-color: #66c0f4; padding: 8px 14px; border-radius: 4px; text-decoration: none; font-weight: bold; }}
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                <h2>Привіт!</h2>
                <p>Ви отримали цей лист, бо ця пошта була вказана під час реєстрації на <a href="https://metodist.co.ua" class="btn">metodist.co.ua</a>.</p>
                ...
                <div class="support">
                    Знайшли баг чи неполадку? Напишіть нам на <a href="mailto:support@metodist.co.ua">support@metodist.co.ua</a>. Ми завжди раді вашому фідбеку.
                </div>
            </div>
            <div class="footer">
