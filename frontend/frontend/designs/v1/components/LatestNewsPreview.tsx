  ...
  return (
    <section className={`${surfaceCardClass} overflow-hidden p-6 md:p-8`}>
      <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <div>
          <div className="inline-flex items-center gap-2 rounded-full bg-pink-500/10 px-4 py-2 text-[10px] font-semibold uppercase text-pink-600 dark:text-pink-300">
            <Newspaper size={14} />
            Останні новини
          </div>
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center justify-center rounded-lg bg-slate-900 px-5 py-4 text-xs font-semibold uppercase text-white shadow-sm transition hover:bg-pink-500 dark:bg-white dark:text-black dark:hover:bg-pink-500 dark:hover:text-white"
        >
          Telegram-канал
        </a>
      </div>
      ...
      <div className="mt-6 grid gap-4 lg:grid-cols-3">
        {items.slice(0, 3).map((item) => (
          <article key={item.id} className="interactive-lift overflow-hidden rounded-xl border border-slate-200/70 bg-slate-50/80 p-3 dark:border-white/10 dark:bg-white/5">
            {item.image_url && (
              <div className="overflow-hidden rounded-lg border border-slate-200/70 bg-slate-100 dark:border-white/10 dark:bg-white/5">
              ...
              {item.telegram_url && (
                <div className="mt-4">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="group inline-flex h-11 items-center overflow-hidden rounded-lg bg-slate-900 text-white transition-all hover:bg-pink-500 hover:pr-4 dark:bg-white dark:text-black dark:hover:bg-pink-500 dark:hover:text-white"
                  >
